...
CREATE TABLE `activities_users` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `activities_users_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `activities_users_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-02-08 19:51:22
